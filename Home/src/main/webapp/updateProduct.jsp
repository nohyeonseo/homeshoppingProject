		...
		<div class="row">
			...
			<form name="updateProduct" action="./processUpdateProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
				...
				<div class="form-group row">
    				...
    				<div class="col-sm-5">
        				<input type="file" name="newProductImage" class="form-control">
    				</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<textarea name="detail" cols="400" rows="6" class="form-control"><%=rs.getString("p_detail")%></textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<input type="text" id="type" name="type" class="form-control" value="<%=rs.getString("p_type")%>">
					</div>
				</div>
